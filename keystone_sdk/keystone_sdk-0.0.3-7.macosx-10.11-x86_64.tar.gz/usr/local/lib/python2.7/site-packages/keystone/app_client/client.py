...
from keystone.app_client.debugger import KPdb
...
from keystone.utils import PY3, builtin_mod
...
class StrategyClient(with_metaclass(abc.ABCMeta)):
    ...
    def init_strategy_runner(self):
        ...
        try:
            ...
            # drain address
            if config.has_key("drain_url"):
                self.strategy_runner.setDrainAddress(config["drain_url"])
        except Exception as e:
